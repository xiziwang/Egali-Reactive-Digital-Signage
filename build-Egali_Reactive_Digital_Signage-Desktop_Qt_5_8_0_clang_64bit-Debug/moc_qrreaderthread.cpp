/****************************************************************************
** Meta object code from reading C++ file 'qrreaderthread.h'
**
...
#include "../Egali_Reactive_Digital_Signage/qrreaderthread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'qrreaderthread.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 30, 0) // ""
    ...
    "QRReaderThread\0messageChanged\0"
};
...
void QRReaderThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QRReaderThread::*_t)();
...
// SIGNAL 0
void QRReaderThread::messageChanged()
{
